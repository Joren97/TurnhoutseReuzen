<template>
  <div class="is-flex is-flex-direction-column" style="min-height: 100vh">
    <b-navbar>
      ...
      <template #end>
        <b-navbar-item tag="router-link" to="/"> Welkom </b-navbar-item>
        <b-navbar-item tag="router-link" to="/reuzen"> Onze reuzen </b-navbar-item>
        <b-navbar-item tag="router-link" to="/fotoboek"> Fotoboek </b-navbar-item>
        <b-navbar-item tag="router-link" to="/indebanvanreuzen">
          In de ban van Reuzen
        </b-navbar-item>
        <b-navbar-item tag="router-link" to="/blog"> Mededelingen </b-navbar-item>
        <b-navbar-item tag="router-link" to="/kleurplaat"> Kleurplaten </b-navbar-item>
        <!-- <b-navbar-dropdown label="Onze reuzen">
          <b-navbar-item tag="router-link" to="/kaartreuzen">
            Kaartreuzen
          </b-navbar-item>
          <b-navbar-item tag="router-link" to="/dorpsreuzen">
            Reuzen dorpsgemeenschap
          </b-navbar-item>
